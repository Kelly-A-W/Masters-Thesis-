...
# Interaction Plots 
#---------------------------
qft_pos_1 = c(0, 1.3548346 -0.5460010 + 0.1709331*1, 0.4601964-0.4601964+0.2954190*1) +0.9468407 -0.1056509*1
qft_neg_1 = c(0, 1.3548346+ 0.1709331*1, 0.4601964+0.2954190*1) -0.1056509*1
qft_pos_2 = c(0, 1.3548346 -0.5460010 + 0.1709331*2, 0.4601964-0.4601964+0.2954190*2) +0.9468407 -0.1056509*2
qft_neg_2 = c(0, 1.3548346+ 0.1709331*2, 0.4601964+0.2954190*2) -0.1056509*2
qft_pos_3 = c(0, 1.3548346 -0.5460010 + 0.1709331*3, 0.4601964-0.4601964+0.2954190*3) +0.9468407 -0.1056509*3
qft_neg_3 = c(0, 1.3548346+ 0.1709331*3, 0.4601964+0.2954190*3) -0.1056509*3
...
# admin*timepnt:
df2 <- data.frame(residuals = resid(mod2),  time = df1$timepnt, Schedule=df1$Schedule)
df2$Schedule <- as.factor(df2$Schedule)
ggplot(df2, aes(y=residuals, x=time)) +
  geom_boxplot(alpha=1, size =1, aes(fill = Schedule), color ="black") +
  theme_minimal()+
