...
# GAIC:
GAIC(int_model, k=round(log(length(df1$R7c..RAc..)), 2)) # choose int_model
GAIC(mod_slo, k=round(log(length(df1$R7c..RAc..)), 2)) 
...
GAIC(mod2, k=round(log(length(df1$R7c..RAc..)), 2))  # choose mod2
GAIC(mod3.1, k=round(log(length(df1$R7c..RAc..)), 2)) 
